 ...
 * dumped at: Tue Sep 15 12:02:01 PM 2026
...
namespace offsets {
    inline constexpr const char* CurrentRobloxVersion = "version-4310300497aa4917";
    ...
    namespace Functions {
        inline constexpr uintptr_t Clone = 0x1651AA0; // better to resolve at runtime via func descriptors
        inline constexpr uintptr_t Destroy = 0x1651AC0; // better to resolve at runtime via func descriptors
        inline constexpr uintptr_t FindPartOnRay = 0xED67B0; // better to resolve at runtime via func descriptors
        inline constexpr uintptr_t FindPartOnRayWithIgnoreList = 0xED6830; // better to resolve at runtime via func descriptors
        inline constexpr uintptr_t FindPartOnRayWithWhitelist = 0xED68C0; // better to resolve at runtime via func descriptors
        inline constexpr uintptr_t FireServer = 0xCB2C30; // better to resolve at runtime via func descriptors
        inline constexpr uintptr_t GetAttribute = 0x1D29E00; // better to resolve at runtime via func descriptors
        inline constexpr uintptr_t GetAttributes = 0x164A4E0; // better to resolve at runtime via func descriptors
        inline constexpr uintptr_t Print = 0x1CD9D90;
        inline constexpr uintptr_t RaisePropertyChanged = 0xF84350;
        inline constexpr uintptr_t Raycast = 0xECDDF0; // better to resolve at runtime via func descriptors
        inline constexpr uintptr_t SetAttribute = 0x1D29AF0; // better to resolve at runtime via func descriptors
        inline constexpr uintptr_t SetParent = 0xE9DBA0;
        inline constexpr uintptr_t SetParentInternal = 0x1D21EE0;
        inline constexpr uintptr_t Shapecast = 0xECF7B0; // better to resolve at runtime via func descriptors
    }
    ...
    namespace TaskScheduler {
        ...
        inline constexpr uintptr_t JobName = 0x560;
